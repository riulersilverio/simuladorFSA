...
def inicializar_dados_times_st():
    ...
    sula_data = { # PREENCHA COM SEUS DADOS COMPLETOS E URLs DE ESCUDO
        "A": [
            {'nome': 'Independiente', 'pontos': 9, 'jogos': 5, 'gp': 9, 'gc': 6, 'escudo_url': ''},
            {'nome': 'Guaraní', 'pontos': 8, 'jogos': 5, 'gp': 9, 'gc': 7, 'escudo_url': ''},
            {'nome': 'Nacional Potosí', 'pontos': 4, 'jogos': 5, 'gp': 8, 'gc': 7, 'escudo_url': ''},
            {'nome': 'Boston River', 'pontos': 1, 'jogos': 5, 'gp': 5, 'gc': 14, 'escudo_url': ''},
        ],
        "B": [
         ...
         "C": [
            {'nome': 'Huracán', 'pontos': 14, 'jogos': 6, 'gp': 11, 'gc': 2, 'escudo_url': ''},
            {'nome': 'Corinthians', 'pontos': 8, 'jogos': 6, 'gp': 5, 'gc': 5, 'escudo_url': 'https://s.sambafoot.com/teams/48_20220411030330.svg'},
            {'nome': 'Racing (URU)', 'pontos': 8, 'jogos': 6, 'gp': 6, 'gc': 5, 'escudo_url': ''},
            {'nome': 'Quarto Time Sula C', 'pontos': 0, 'jogos': 6, 'gp': 0, 'gc': 15, 'escudo_url': ''},
        ],
        "D": [
        ...
        "F": [
            {'nome': 'Once Caldas', 'pontos': 12, 'jogos': 5, 'gp': 8, 'gc': 4, 'escudo_url': ''},
            {'nome': 'Fluminense', 'pontos': 10, 'jogos': 5, 'gp': 9, 'gc': 2, 'escudo_url': 'https://s.sambafoot.com/teams/52_20220411030348.svg'},
            {'nome': 'Gualberto Villarroel', 'pontos': 4, 'jogos': 5, 'gp': 5, 'gc': 11, 'escudo_url': ''},
            {'nome': 'Unión Española', 'pontos': 2, 'jogos': 5, 'gp': 2, 'gc': 7, 'escudo_url': ''},
        ],
        "G": [
